  ...
  return (
    <div className="min-h-[calc(100vh-160px)] flex flex-col justify-center items-center px-4">
      <div className="w-full max-w-[400px] border border-zinc-800 bg-[#09090b] rounded-xl p-8 shadow-[0_8px_32px_rgba(0,0,0,0.4)] transition-all duration-300">
        ...
        {(process.env.NEXT_PUBLIC_GITHUB_CLIENT_ID && process.env.NEXT_PUBLIC_GITHUB_CLIENT_ID !== 'your-github-client-id') && (
          <Link 
            href="/api/auth/github"
            className="w-full flex items-center justify-center gap-3 bg-transparent border border-zinc-800 text-zinc-200 font-medium py-2.5 rounded-lg text-sm transition-colors hover:bg-zinc-900 no-underline"
          >
